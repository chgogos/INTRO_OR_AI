...
if __name__ == "__main__":
    ...
    possible_meeting_times = {
        ...
        "meeting_e": [
            [time_to_index(hour=10, minute=0), time_to_index(hour=11, minute=0)],
        ],
    ...
    # meeting_d must be after meeting_b
    model.add(interval_vars["meeting_d"].start_expr() >= interval_vars["meeting_b"].end_expr())
